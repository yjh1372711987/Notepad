...
public class UpdateNote extends HttpServlet {
   ...
   final static String URL = "jdbc:mysql://180.76.151.237/linux_final";
   final static String USER = "root";
   final static String PASS = "1372711987Ab!";
   final static String SQL_INSERT_NOTEPAD = "UPDATE t_Notepad SET Notepad_Time = ?,Notepad_Content =? WHERE id=?;";
   ...
   private int CreateNote(Notepad req) {
      ...
      try {
         ...
         stmt.setString(1, req.Notepad_Time);
                 stmt.setString(2, req.Notepad_Content);
